...
export const BANNER_EVENTS: BannerEvent[] = [
  ...
  // Update or remove this for production
  {
    ...
    type: 'announcement',
    priority: 'high',
    title: 'Welcome to HTX Creamery',
    description: "Houston's favorite handcrafted ice cream — made fresh daily!",
    linkUrl: '/restaurant-business/menu',
    linkText: 'View Menu',
  ...
  // Example: Special Event
  {
    ...
    linkUrl: '/restaurant-business/contact',
    linkText: 'Learn More',
